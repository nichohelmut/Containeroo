...
User.create(first_name: 'Hans', last_name: 'müller', email: 'hans@gmail.com', password: 123_456)
User.create(first_name: 'Max', last_name: 'meier', email: 'max@gmail.com', password: 123_456)
User.create(first_name: 'Jim', last_name: 'Kennedy', email: 'jim@gmail.com', password: 123_456)
User.create(first_name: 'Nicholas', last_name: 'Utikal', email: 'nicholasutikal@gmail.com', password: 123_456)
User.create(first_name: 'Markus', last_name: 'Haag', email: 'markus@gmail.com', password: 123_456)
User.create(first_name: 'Peter', last_name: 'Tänzer', email: 'peter@gmail.com', password: 123_456)
